...
I love `Janggelan` so much for sure. But saddest, I don't see why I have to continue `Janggelan`'s development and make it to be part of future web programming. So, yes... `Janggelan` is discontinued for now.
